...
import { useElementVisible, usePosts, useSectionVisible } from "../lib/useSiteData";
...
export default function Blog() {
  ...
  const showHero = useSectionVisible("blog", "hero");
  const showArticles = useSectionVisible("blog", "articles");
  const showClosing = useSectionVisible("blog", "closing");
  const showHeroCopy = useElementVisible("blog", "hero", "copy");
  const showTopics = useElementVisible("blog", "articles", "topics");
  const showFeatured = useElementVisible("blog", "articles", "featured");
  const showLists = useElementVisible("blog", "articles", "lists");
  const showPictures = useElementVisible("blog", "articles", "pictures");
  const showClosingCopy = useElementVisible("blog", "closing", "copy");
  const showClosingButtons = useElementVisible("blog", "closing", "buttons");
