...
export default function Contact() {
  ...
  return (
    <div ref={revealRef} className="bg-wash relative overflow-hidden">
      <Blob tone="brand" strength={0.16} blur={42} size={420} duration="20s" className="-left-[130px] -top-[120px]" />
      <Grain opacity={0.05} />
...
function ContactCard({ icon, label, delay, motion, children }: {
  ...
  return (
    <div
      data-reveal={delay}
      className={`${motion} reveal-slow flex items-start gap-4 rounded-lg bg-surface-raised p-6 shadow-soft transition-all duration-(--duration-base) ease-(--ease-out-quart) hover:-translate-y-1 hover:shadow-soft-hover`}
    >
